...
// by the FG path, 1 = model track: OfaFlow2, 2 = current frame -> model frame for the
// residual warp: OfaFlow3). Does not touch OfaCurrent. Returns the OfaFence value that
